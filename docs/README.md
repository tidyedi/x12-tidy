...
| [using-x12-tidy.md](using-x12-tidy.md) | Developer guide: the CLI, the `tidy()` one-call API and result types, the lower-level building blocks, and formatting your own report. |
