...
"""Envelope QA/QC -- runs once :func:`~x12_tidy.structure.clean_payload` has
produced a payload.
...
See :mod:`x12_tidy.qaqc.envelope` for the full scope (what's checked, what's
deliberately not) and the severity contract.
"""

from __future__ import annotations

from x12_tidy.qaqc.envelope import EnvelopeFacts, QaQcResult, check_payload
